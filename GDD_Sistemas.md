...
> *Unique 2.5D illustrative art style, precisely replicating the textured finish and hybrid expressive from Fate Series and One Piece. Dynamic comic book line art with defined, variable-width ink outlines and strategic cross-hatching for texture on skin and armor. Rich, painterly digital illustration — all surfaces have visible, tactile brush strokes and painterly texture. Semi-cel-shaded with painterly depth. Character faces distinct and non-generic with visible skin texture and slightly asymmetrical features. Intense, cinematic, dramatic high-contrast shadows. Saturated color palette. Deep painterly background with atmospheric haze.*
