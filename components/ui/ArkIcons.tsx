...
function makeIcon(d: string, viewBox = '0 0 24 24') {
  return function ArkIcon({ className = 'text-[var(--ark-gold)]', size = 18 }: IconProps) {
    return (
      <svg
...
export const SwordIcon = ({ className = 'text-[var(--ark-gold)]', size = 18 }: IconProps) => (
...
export const MagicIcon = ({ className = 'text-[var(--ark-gold)]', size = 18 }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
/** Defesa — escudo */
export const ShieldIcon = ({ className = 'text-[var(--ark-gold)]', size = 18 }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
/** Vitalidade — coração */
export const HeartIcon = ({ className = 'text-[var(--ark-gold)]', size = 18 }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
/** Velocidade — raio */
export const ZapIcon = ({ className = 'text-[var(--ark-gold)]', size = 18 }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
/** Precisao — alvo */
export const TargetIcon = ({ className = 'text-[var(--ark-gold)]', size = 18 }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
/** Tenacidade — âncora */
export const AnchorIcon = ({ className = 'text-[var(--ark-gold)]', size = 18 }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
/** Capitania — coroa */
export const CrownIcon = ({ className = 'text-[var(--ark-gold)]', size = 18 }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
/** Moral — chama */
export const FlameIcon = ({ className = 'text-[var(--ark-gold)]', size = 18 }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
/** Libras — moeda */
export const CoinIcon = ({ className = 'text-[var(--ark-gold)]', size = 18 }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <circle cx="12" cy="12" r="10" />
    <path d="M9 12h6" />
    <path d="M12 9v6" />
...
/** Essencia — cristal */
export const CrystalIcon = ({ className = 'text-[var(--ark-gold)]', size = 18 }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
/** Premium — diamante */
export const DiamondIcon = ({ className = 'text-[var(--ark-gold)]', size = 18 }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
